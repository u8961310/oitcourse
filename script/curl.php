...
{
	$sql="Insert Into course (syear,cos_dept,cos_num,cos_title,cos_require,cos_credit,cos_hours,cos_teacher,cos_room,cos_time) values ('".$cos_array[$i]['syear']."','".$cos_array[$i]['cos_dept']."','".$cos_array[$i]['cos_num']."','".$cos_array[$i]['cos_title']."','".$cos_array[$i]['cos_require']."','".$cos_array[$i]['cos_credit']."','".$cos_array[$i]['cos_hours']."','".$cos_array[$i]['cos_teacher']."','".$cos_array[$i]['cos_room']."','".$cos_array[$i]['cos_time']."');";
	mysql_query($sql);
	echo $cos_array[$i]['cos_num'].",".$cos_array[$i]['cos_title']."<b>INSERT.</b><br />";
